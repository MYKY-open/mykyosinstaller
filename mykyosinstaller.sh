...
KEYMAP="cz-qwertz"
SWAPPINESS="100"
KERNEL_PARAMS="mem_sleep_default=deep nowatchdog threadirqs irqaffinity=0-1 preempt=lazy transparent_hugepage=madvise split_lock_detect=off zswap.shrinker_enabled=0 tsc=reliable clocksource=tsc audit=0 mce=off rcutree.enable_rcu_lazy=1 rcutree.rcu_normal_wake_from_gp=0"
